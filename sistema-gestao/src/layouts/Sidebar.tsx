        ...
        <>
            ...
            <aside
                className={clsx(
                    ...
                    // Width logic: Mobile (Hidden/Full), Desktop (Mini/Full)
            ...
            >
                    ...
                    <div className={clsx("flex items-center gap-3 overflow-hidden transition-all duration-300", collapsed ? "justify-center w-full" : "")}>
                        {collapsed ? (
                            <img
                                ...
                                alt="Logo"
                                className="h-8 w-auto object-contain hidden md:block" // Hide logo on mobile when collapsed (essentially hidden anyway)
                            ...
                            <>
                                ...
                                <button
                                    onClick={() => setCollapsed(true)}
                                    className="md:hidden ml-auto p-2 text-slate-400 hover:bg-slate-100 rounded-xl"
                                >
                ...
                <div className="p-4 border-t border-slate-100 bg-slate-50/50">
                    <button
                        ...
                        className="hidden md:flex items-center justify-center w-full p-2 text-slate-400 hover:text-slate-600 hover:bg-slate-100 rounded-xl transition-colors mb-4"
                    >
