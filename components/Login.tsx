            ...
            <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-1">
              {UNITS_CONTACT_INFO.map(unit => (
                <div key={unit.name} className="p-4 bg-gray-50 rounded-xl border border-gray-100 hover:bg-blue-50 hover:border-blue-200 transition-colors group">
                  ...
                  <a href={`https://wa.me/${unit.whatsapp}?text=Olá, gostaria de falar com a secretaria.`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-green-600 font-bold text-sm bg-white p-2 rounded-lg border border-green-100 shadow-sm group-hover:shadow-md transition-all justify-center">
