      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4 py-8">
        ...
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden relative">
          ...
          <div className="flex border-b border-gray-200 bg-gray-50">
            <button
              className={`flex-1 py-3 text-xs sm:text-sm font-medium text-center focus:outline-none focus:ring-0 focus:ring-offset-0 outline-none select-none transition-colors border-b-2 ${
