...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative">
      ...
      <header className="bg-white shadow-sm border-b border-gray-200"><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center"><div className="flex items-center gap-3"><SchoolLogo variant="header" /><div><h1 className="text-xl font-bold text-gray-900">Meu Expansivo</h1><p className="text-sm text-gray-500">Administração ({adminUnit || 'GERAL'}) - {admin.name}</p></div></div><Button variant="secondary" onClick={onLogout}>Sair</Button></div></header>
