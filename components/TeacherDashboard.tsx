    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      <div className="max-w-7xl mx-auto bg-white shadow-lg rounded-lg p-6">
        ...
        <div className="flex space-x-4 mb-6 border-b">
            <button onClick={() => setActiveTab('grades')} className={`pb-3 px-1 font-semibold border-b-2 ${activeTab === 'grades' ? 'text-blue-950 border-blue-950' : 'text-gray-500 border-transparent hover:text-gray-700'}`}>
                { selectedStudent && isEarlyChildhoodStudent ? 'Lançar Relatório' : 'Lançar Notas'}
            </button>
            <button onClick={() => setActiveTab('attendance')} className={`pb-3 px-1 font-semibold border-b-2 ${activeTab === 'attendance' ? 'text-blue-950 border-blue-950' : 'text-gray-500 border-transparent hover:text-gray-700'}`}>
                Chamada Diária
            </button>
        </div>
