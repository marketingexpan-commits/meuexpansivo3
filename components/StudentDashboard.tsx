            ...
            <div className="space-y-6">
                <div className="flex gap-4 mb-4 print:hidden">
                    <button 
                        ...
                        className={`px-4 py-2 rounded font-bold text-sm transition-colors ${selectedReportSemester === 1 ? 'bg-blue-950 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
                    >
                        1º Semestre
                    </button>
                    <button 
                        onClick={() => setSelectedReportSemester(2)}
                        className={`px-4 py-2 rounded font-bold text-sm transition-colors ${selectedReportSemester === 2 ? 'bg-blue-950 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
                    >
                        2º Semestre
                    </button>
                </div>
