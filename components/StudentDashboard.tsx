                ...
                {currentView === 'menu' && (
                    <div className="animate-fade-in-up">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <a
                                href="#"
                                className="flex items-center justify-center p-4 bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-100 transition-colors gap-3"
                                onClick={(e) => { e.preventDefault(); /* Handle Fale Conosco link */ }}
                            >
                                ...
                                <span className="font-bold text-gray-700">Fale Conosco (WhatsApp)</span>
                            </a>
                            <a
