        ...
        <label className={twMerge("flex items-center gap-2 cursor-pointer group", className)}>
            <div className="relative flex items-center justify-center">
                <input
                    ...
                    {...props}
                />
                <div className="w-5 h-5 border-2 border-slate-300 rounded rounded-md transition-all peer-checked:border-blue-600 peer-checked:bg-blue-600 group-hover:border-blue-400">
                    <svg
