...
export const MOCK_CALENDAR_EVENTS: CalendarEvent[] = [
    ...
    { id: 'ev2', title: 'Carnaval', startDate: '2026-02-16', endDate: '2026-02-18', type: 'holiday', description: 'Recesso escolar.', units: ['all'] },
    ...
    { id: 'ev5', title: 'Dia do Trabalho', startDate: '2026-05-01', type: 'holiday', units: ['all'] },
    ...
    { id: 'ev8', title: 'Independência do Brasil', startDate: '2026-09-07', type: 'holiday', units: ['all'] },
