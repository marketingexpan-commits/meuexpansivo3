...
export const pedagogicalService = {
    ...
    calculateFrequencyFromGrades(grades: GradeEntry[], gradeLevel: string = "Fundamental I", attendanceRecords: AttendanceRecord[] = [], academicSubjects?: AcademicSubject[]) {
        ...
        const freqString = calculateGeneralFrequency(grades, attendanceRecords, studentId, gradeLevel, undefined, undefined, academicSubjects);
