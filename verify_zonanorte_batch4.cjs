...
async function verify() {
    console.log("Verifying Zona Norte Batch 4...");

    const checkList = [
        { id: 'student_4416', expectedGrade: '1º Ano - Fundamental I', expectedShift: 'Matutino', expectedClass: 'A' },
        { id: 'student_4418', expectedGrade: 'Nível V - Edu. Infantil', expectedShift: 'Vespertino', expectedClass: 'B' },
        { id: 'student_4426', expectedGrade: '3ª Série - Ens. Médio', expectedShift: 'Matutino', expectedClass: 'A' },
        { id: 'student_4900', expectedGrade: 'Nível V - Edu. Infantil', expectedShift: 'Vespertino', expectedClass: 'B' }
    ];
