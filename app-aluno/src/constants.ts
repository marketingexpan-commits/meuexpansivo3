...
import { CURRICULUM_MATRIX, ACADEMIC_GRADES, HS_SUBJECTS_2025 } from './utils/academicDefaults';
export { CURRICULUM_MATRIX, ACADEMIC_GRADES, HS_SUBJECTS_2025 };
...
export const UNITS_DATA: Record<string, { address: string; phone: string; email: string; cnpj: string }> = {
  [SchoolUnit.UNIT_BS]: {
    address: 'Av. Boa Sorte, 265 - Nossa Senhora da Apresentação, Natal - RN',
    phone: '84988277188',
    email: 'boasorte@meuexpansivo.com.br',
    cnpj: '00.000.000/0000-00'
  },
  [SchoolUnit.UNIT_EXT]: {
    address: 'Rua do Futebol, 32 - Estivas, Extremoz - RN',
    phone: '84981863522',
    email: 'extremoz@meuexpansivo.com.br',
    cnpj: '00.000.000/0000-00'
  },
  [SchoolUnit.UNIT_ZN]: {
    address: 'Rua Desportista José Augusto de Freitas, 50 - Pajuçara, Natal - RN',
    phone: '84998362024',
    email: 'zonanorte@meuexpansivo.com.br',
    cnpj: '00.000.000/0000-00'
  },
  [SchoolUnit.UNIT_QUI]: {
    address: 'Rua Coemaçu, 1045 - Quintas, Natal - RN',
    phone: '84999540167',
    email: 'quintas@meuexpansivo.com.br',
    cnpj: '00.000.000/0000-00'
  }
};

export const DEFAULT_UNIT_DATA = UNITS_DATA[SchoolUnit.UNIT_ZN];
