    ...
    return (
        <div className="space-y-6 animate-in slide-in-from-right-4 fade-in duration-300 pb-20">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center bg-white p-4 sm:p-5 rounded-2xl border border-gray-100 shadow-sm gap-4 sm:gap-2">
                <div>
                    <h2 className="text-lg sm:text-xl font-black text-blue-950 uppercase tracking-tight">Achados e Perdidos</h2>
                    <p className="text-[10px] sm:text-xs text-gray-400 font-bold uppercase tracking-wider mt-0.5">Gestão de itens na portaria</p>
                </div>
                <button
