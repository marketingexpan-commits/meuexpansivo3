...
export const FinanceiroScreen: React.FC<FinanceiroScreenProps> = ({ student, mensalidades = [], eventos = [], unitContacts = [], contactSettings, onPaymentSuccess }) => {
    ...
    const handleCreatePayment = async (cpfOverride?: string, nameOverride?: string, phoneOverride?: string, emailOverride?: string, addressOverride?: any) => {
        ...
        try {
            ...
            const finalPrice = Number(((selectedMethod === 'credito' || selectedMethod === 'debito') ? amount * 1.05 : amount).toFixed(2));
                    ...
                    <div className="bg-white rounded-3xl p-8 max-w-lg w-full text-center space-y-6 shadow-2xl animate-scale-in max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            ...
                            <button
                                ...
                                className={`p-4 border-2 rounded-xl flex flex-col items-center gap-2 transition-all hover:scale-105 ${selectedMethod === 'credito' ? 'border-purple-500 bg-purple-50 shadow-md ring-2 ring-purple-200' : 'border-gray-100 hover:border-gray-300'}`}
                            >
                                <span className="text-2xl">💳</span>
                        ...
                        <div className="bg-gray-50 p-4 rounded-xl space-y-2 border border-gray-100">
                            ...
                            {(() => {
                                ...
                                const isCard = selectedMethod === 'credito';
                        ...
                        <div className="flex gap-3">
                            ...
                            <Button onClick={() => {
                                ...
                                if (student.cpf_responsavel && student.cpf_responsavel.replace(/\D/g, '').length === 11) {
                                    ...
                                    const payerPhone = student.telefone_responsavel ? student.telefone_responsavel.replace(/\D/g, '') : (student.telefone_contato ? student.telefone_contato.replace(/\D/g, '') : '84999999999');
                                    const payerEmail = student.email_responsavel || 'financeiro@meuexpansivo.com.br';
